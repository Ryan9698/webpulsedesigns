...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="relative w-full max-w-screen-xl px-4 bg-gray-900/70 text-gray-300 flex items-center justify-center backdrop-blur-md shadow-lg border-b border-white/10 z-40">
        <DebugViewport />
